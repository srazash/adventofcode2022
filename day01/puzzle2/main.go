...
func main() {
	...
	fmt.Printf("Total cals carried by the top three Elves: %d\n", topThreeCal(input))
}
...
func topThreeCal(in []int) int {
	...
	return totalCal[len(totalCal)-1] + totalCal[len(totalCal)-2] + totalCal[len(totalCal)-3]
